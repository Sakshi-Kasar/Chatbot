...
public class chatbot extends JFrame implements ActionListener
{
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		else if(message.contains("i am good")||message.contains("ok")||message.contains("fine ")&&message.contains("good"))
		{
		...
		else
		{
				try
				{
					URL url=new URL("https://[Log in to view URL]");
					URLConnection connection=url.openConnection();
					connection.connect();
					bot("Here some results for you ...");
					java.awt.Desktop.getDesktop().browse(java.net.URI.create("http://[Log in to view URL]"+message.replace(" ", "+")+"&btnG=Google+Search"));
